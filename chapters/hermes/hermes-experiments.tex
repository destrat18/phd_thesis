...
\begin{table}[]
    \centering
    \input{chapters/hermes/hermes-tables/solvedComp-hermes.tex}
    \caption{Success rates for Hermes (ours) on routing queries for four token set sizes.}
    \label{table:hermes-solvedComp-hermes}
\end{table}

\begin{table}[]
    \centering
    \input{chapters/hermes/hermes-tables/solvedComp-mmbf.tex}
    \caption{Success rates for MMBF on routing queries for four token set sizes.}
    \label{table:hermes-solvedComp-mmbf}
\end{table}

\begin{table}[]
    \centering
    \input{chapters/hermes/hermes-tables/solvedComp-bf.tex}
    \caption{Success rates for BF on routing queries for four token set sizes. ``Failed'' indicates cases where the tool did not work due to negative cycles.}
    \label{table:hermes-solvedComp-bf}
\end{table}


\begin{table}[]
    \centering
    \input{chapters/hermes/hermes-tables/runtimeResult.tex}
