...
\begin{itemize}
    ...
    \item In Chapter~\ref{chp:mining}, we consider the problem of forming an optimal block of transactions, i.e.~a block with maximum total transaction fees, in Cardano and Ethereum. Our contributions are as follows:
    \begin{itemize}
