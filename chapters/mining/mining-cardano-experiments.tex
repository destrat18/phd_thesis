\section{Evaluation on Real Cardano Blocks}\label{sec:mining-cardano-experiments} 
...
\begin{figure}
	\centering
	\includegraphics[width=0.8\linewidth]{chapters/mining/mining-cardano-figures/tdp.pdf}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\linewidth]{chapters/mining/mining-cardano-figures/incPer.pdf}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\linewidth]{chapters/mining/mining-cardano-figures/incADA.pdf}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\linewidth]{chapters/mining/mining-cardano-figures/incUsd.pdf}
