...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.55]{chapters/mining/mining-cardano-figures/tdpGraph.pdf}
...
\begin{figure}
	\begin{center}
		\includegraphics[scale=0.55]{chapters/mining/mining-cardano-figures/tdpDec.pdf}
	\end{center}
