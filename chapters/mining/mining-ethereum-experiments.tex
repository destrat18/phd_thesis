\section{Revenue Gains and Runtime on Real-World Ethereum Blocks}\label{sec:mining-ethereum-experiments}

\paragraph{Implementation}
We implemented our approach in Python 3 and Rust. Our tool is available at~\url{https://anonymous.4open.science/r/boosting_gas_revenues_of_ethereum_miners/}. We used Anvil~\cite{foundry2023anvil} and Erigon~\cite{erigontech2023erigon} to execute Ethereum transactions in our samples and obtain their gas usage. Moreover, we used  Linfa~\cite{linfa2025linfa} to generate decision trees and relied on SCIP~\cite{bolusani2024scip} for solving Integer Linear Programming (ILP) instances.
