...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{chapters/options/figures/asicPriceJTH.pdf}
...
\begin{table}
	\centering
	\input{chapters/options/tables/qcost.tex}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{chapters/options/figures/costHistorical.pdf}
