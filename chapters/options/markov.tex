\section{Block-reverting as a Minority Miner} \label{sec:options-markov}
...
\begin{center}
\includegraphics[width=.9\linewidth]{chapters/options/start.pdf}
\end{center}
...
\begin{center}
	\includegraphics[width=.9\linewidth]{chapters/options/minus5.pdf}
\end{center}
...
\begin{center}
	\includegraphics[width=.9\linewidth]{chapters/options/abandon.pdf}
\end{center}
...
\paragraph{Variant B} The attacker does not necessarily need to wait until her chain becomes strictly longer (state $1$). She can already publish her chain when it has the same length as the other (honest) chain, which corresponds to state $0$. At this point, since there are two chains of the same length, the honest miner are free to choose which chain to extend. Assuming they have no bias, half of the honest mining power will then be used in extending the attackers chain. This variant of the attack can be modeled by the Markov chain in Figure~\ref{fig:options-vB} and is slightly more likely to succeed. 

\begin{figure*}
	\includegraphics[width=\linewidth]{chapters/options/variantB.pdf}
	\caption{The Markov chain modeling variant B of the attack.}
	\label{fig:options-vB}
\end{figure*} 
...
\begin{figure}
    \begin{subfigure}[b]{\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{chapters/options/figures/variantA50.pdf}
        \vfill
        \includegraphics[width=0.9\textwidth]{chapters/options/figures/variantA365.pdf}
    \end{subfigure}
    ...
    \label{fig:options-attackA}
\end{figure}

\begin{figure}
    \begin{subfigure}[b]{\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{chapters/options/figures/variantB50.pdf}
        \vfill
        \includegraphics[width=0.9\textwidth]{chapters/options/figures/variantB365.pdf}
    \end{subfigure}
