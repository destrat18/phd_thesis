...
% Unify paragraph macros: \para is the only definition, \paragraph uses \para
...
\lstset{
	morekeywords={PUSH1, SLOAD, XOR, DUP2, SWAP1, SWAP2, POP},
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Hermes paper macros (from the original Hermes paper source)
% Policy: do NOT redefine existing thesis-wide macros.
% If a Hermes-paper macro would conflict, keep the paper version commented
% out with a note so you can decide.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% Hermes paper had:

% Hermes paper:
%   \newcommand*{\enhance}[1]{\textcolor{black}{#1}}
\providecommand*{\enhance}[1]{\textcolor{black}{#1}}
...
% Hermes paper had: \newcommand{\fee}{\phi}
% CONFLICT: this thesis uses \fee for fee-related notation elsewhere.
% Use \cfee for the Hermes-paper meaning instead.
% \newcommand{\fee}{\phi}
...
\newcommand{\opt}{\textsf{Optimized}}
\newcommand{\syr}{\textsf{syr}}
\newcommand{\leastgas}{\textsf{leastGas}}
\newcommand{\bestblock}{\textsf{bestBlock}}
\newcommand{\XOR}{^\wedge}
...
% NOTE: `thmstyletwo` was referenced here but never defined, which breaks
% compilation with amsthm. Use a standard theoremstyle instead.
...
% Cryptocurrency and token market cap macros
\newcommand{\ethcap}{\ensuremath{\textup{ETH Cap}}\xspace}
\newcommand{\btccap}{\ensuremath{\textup{BTC Cap}}\xspace}
\newcommand{\adacap}{\ensuremath{\textup{ADA Cap}}\xspace}
\newcommand{\usdtcap}{\ensuremath{\textup{USDT Cap}}\xspace}
\newcommand{\usdccap}{\ensuremath{\textup{USDC Cap}}\xspace}
\newcommand{\dexcap}{\ensuremath{\textup{DEX Cap}}\xspace}

% Gas fees paid by user
\newcommand{\userpaid}{\ensuremath{\textup{user-paid}}\xspace}
\newcommand{\gasfees}{\ensuremath{\textup{gas-fees}}\xspace}