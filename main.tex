...
\subject{Computer Science} % Subject of the Degree.
\department{Department of Computer Science}       % Department to which the thesis is submitted.
\advisor{Amir Goharshady}     % Supervisor. Additional co-supervisor can be added using \member
...
\input{macros-hkust.tex}
% \input{macros-ilep-hkust.tex}
